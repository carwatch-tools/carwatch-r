...
The [focused gallery](https://github.com/carwatch-tools/carwatch-r/tree/main/examples/gallery)
contains shorter examples for one task at a time, including spreadsheet-based
issue review, multi-registration protocols, saliva merging, and feature
calculation.
...
timeline or conversion-decision editor. In the editor, select an issue, apply a
decision, then use **Refresh remaining issues** to update the conversion. `Done`
returns the complete decision table.
