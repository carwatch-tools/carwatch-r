---
title: "Developing carwatch"
description: "Package checks, example rendering, and release workflows for carwatch contributors."
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Developing carwatch}
...
[CARWatch tutorials](tutorials.html).
...
2. Start `NEWS.md` with `# carwatch <version>` and update `cran-comments.md`.
...
CRAN submission itself is intentionally not performed by the workflow. It is a
reviewed submission with an email-confirmation step, whereas the GitHub release
can be reproduced safely from the accepted tag.
